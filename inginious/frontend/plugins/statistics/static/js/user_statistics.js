    ...
    "colors":
        {
            ...
            "PRESENTATION_ERROR": 'rgb(59,105,139)',
...
const BarSubmissionsPerTasks = (function () {
    ...
    BarSubmissionsPerTasks.prototype._plotData = function (data) {
        ...
        const presentation_error_data = this.createObjectToPlotData(data, data_count_obj, "PRESENTATION_ERROR",
            colors["PRESENTATION_ERROR"]);
        ...
        const plotData = [compilation_error_data, time_limit_data, memory_limit_data, runtime_error_data,
            wrong_answer_data, output_limit_error_data, grading_error_data, presentation_error_data, accepted_data];
